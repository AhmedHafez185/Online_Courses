                            ...
                            <div class="col-lg-8">
                                ...
                                <section id="lessons">
                                    ...
                                    <div id="accordion_lessons" role="tablist" class="add_bottom_45">
                                        <c:forEach items="${course.outlines}" var="courseOutlines">
                                            <div class="card">
                                                <div class="card-header" role="tab" id="heading${courseOutlines.id}">
                                                    <h5 class="mb-0">
                                                        <a class="collapsed" data-toggle="collapse" href="#collapse${courseOutlines.id}" aria-expanded="false" aria-controls="collapse${courseOutlines.id}">
                                                            <i class="indicator ti-plus"></i>${courseOutlines.outline}
                                                        </a>
                                                    </h5>
                                                </div>
                                                <div id="collapse${courseOutlines.id}" class="collapse" role="tabpanel" aria-labelledby="heading${courseOutlines.id}" data-parent="#accordion_lessons">
                                                    <div class="card-body">
